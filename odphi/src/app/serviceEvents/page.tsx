...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <p className={inter.className + " text-[20px] mb-[2rem] ml-[10rem] mr-[10rem] text-center"}>We proudly highlight some of the esteemed organizations we&aposve collaborated with, participating in their inspiring events with great enthusiasm. We look forward to nurturing these connections and forging new partnerships in the future to further our shared goals.</p>
