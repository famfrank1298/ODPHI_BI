...
export default function NuCard(props) {
  return (
    <div>
      ...
      <div className={inter.className + " line-titles section-name"}>Fall 2022 - {props.info[0]["line-name"]} Line</div>
      
      <div className="wrap grid-3">
        {props.info.map(function (bro, i) {
          return <div className="box" key={i}>
                    <img className="box-image mb-[1rem]" src={props.info[i]["pic-link"]}  alt="Nu Line Brother"/>
