...
export default function XiCard(props) {
  return (
    <div>
      ...
      <div className={inter.className + " line-titles section-name"}>Fall 2021 - {props.info[0]["line-name"]} Line</div>
      
      <div className="single-line">
        {props.info.map(function (bro, i) {
          return <div className="box" key={i}>
            <img className="box-image mb-[1rem]" src={props.info[i]["pic-link"]}  alt="Lambda Line Brother"/>
