    ...
    return (
        <div className="flex w-full mb-[5rem]">
            <div className="container flex w-full mt-[3rem]">
                <div className="cta">
                <Image className="pillar-img" src="/pillars/unity.JPG" alt="UNITY"/>
                <div className="text">
            ...
            <div className="container flex w-full mt-[3rem]">
                <div className="cta">
                <Image className="pillar-img" src="/pillars/honesty.JPG" alt="HONESTY"/>
                <div className="text">
            ...
            <div className="container flex w-full mt-[3rem]">
                <div className="cta">
                    <Image className="pillar-img" src="/pillars/integrity.JPG" alt="INTEGRITY"/>
                    <div className="text">
            ...
            <div className="container flex w-full mt-[3rem]">
                <div className="cta">
                <Image className="pillar-img" src="/pillars/leadership.JPG" alt="LEADERSHIP"/>
                <div className="text">
